      ...
      <section className="h-screen bg-gray-400">
        <div className="px-6 h-full text-gray-800">
          ...
          >
            ...
            >
              <h1 className="content-center font-bold text-5xl text-green-600">
                Welcome! Sign in Gremblo!</h1>
              <img
                  src="https://www.everythingreptiles.com/wp-content/uploads/2020/07/Pixie-Frog.jpg"
                  className="w-full"
                  alt="Sample image"
              />
            </div>
              ...
              <form>
                <div className="flex flex-row items-center justify-center lg:justify-start">
                  ...
                  <button
                      ...
                      className="inline-block p-3 bg-green-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out mx-1"
                  >
